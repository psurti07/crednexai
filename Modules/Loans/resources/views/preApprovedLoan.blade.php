    ...
    <div class="container-xxl " id="kt_content_container">
        <div class="row g-8 mt-3 mb-10">
            ...
            <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                <div
                    class="alert alert-dismissible bg-light-danger border border-danger d-flex flex-column flex-sm-row p-5">
                ...
                <div class="offer-card locked">
                    ...
                    <div class="card {{ $isExpired ? 'card-content' : '' }} h-md-100">
                        <div class="card-header d-flex justify-content-center align-items-center border-0"
                            style="{{ $loop->index != 0 ? 'background: rgba(0, 0, 0, 0) linear-gradient(120deg, #f94, #D9455A) 0 0 no-repeat;' : 'background: rgba(0, 0, 0, 0) linear-gradient(120deg, #62ffc6, #59b006) 0 0 no-repeat;' }}min-height:20px!important">
                            <h3 class="card-title">
                                <span
                                    class="card-label fw-semibold fs-base text-light">{{ $loop->index == 0 ? 'Highly Recommended' : 'Pre-Approved Offers' }}</span>
                            </h3>
                        </div>
                        <div class="card-body pt-7 px-0">
                            <div class="px-5">
                                <img src="{{ 'https://manage.crednexai.com/upload/banks/'.$offer->bank_image }}"
                                    alt="{{ $offer->bank_name }}" width="150">
                            </div>
                            <div class="separator separator-dashed my-6"></div>
                            <div class="px-5">
                                <h4 class="fw-bold text-gray-900 mb-4 me-1" style="line-height: 2.2rem;">
                                    {{ $offer->title }}</h4>

                                <div class="fw-semibold pe-2" style="font-size:14px!important">
                                    @if($offer->option1!=NULL)
                                    <p class="text-dark me-5 mb-2">
                                        <i class="ki-duotone ki-check-circle me-1"><span class="path1"></span><span
                                ...
                                <div class="mt-5">
                                    <a href="javascript:;" data-id="{{ $offer->apply_id }}"
                                        data-url="{{ $offer->applyurl }}"
                                        class="btn btn-sm btn-success align-self-center apply-now-btn">Apply Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row g-8 mb-5">
            <div class="col-12">
                <p><strong>Ready with the following documents: <br />Salaried - </strong>PAN Card, Aadhaar Card, Salary
                    Slip, Bank Statements; <strong>Self Employeed - </strong>PAN Card, Aadhaar Card, IT Return, Bank
                    Statements</p>
                <p><strong>Disclaimer:</strong> Pre-Approved Offers are solely tentative and are shown on the basis of
                    the information shared by the user – the final loan approval, sanction, and disbursement depend on
                    the user profile and the NBFCs’ rules and regulations.</p>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="kt_modal_view_users" data-bs-keyboard="false" data-bs-backdrop="static" tabindex="-1"
