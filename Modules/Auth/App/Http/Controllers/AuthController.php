...
class AuthController extends Controller
{
    ...
    public function authenticate(Request $request)
    {
        try {
            ...
            Log::error('authenticate:', ["message" => $e->getMessage(), "traceAsString" => $e->getTraceAsString()]);
    ...
    public function forgetPasswordStore(Request $request)
    {
        try {
            ...
            Log::error('forgetPasswordStore:', ["message" => $e->getMessage(), "traceAsString" => $e->getTraceAsString()]);
