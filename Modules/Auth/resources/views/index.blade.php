...
<body>
    ...
    <div id="page" class="page font--jakarta">
        <div id="login" class="bg--fixed login-1 login-section division">
            <div class="container">
                <div class="row align-items-center justify-content-center bg--green-100 mx-2">
                    <div class="col-md-6 col-lg-6 col-12 order-md-1 order-2 p-0">
                        <div class="d-flex justify-content-center align-items-start">
                            <div class="img-block">
                                <img src="{{ asset('front/images/login-image-01.png') }}" alt="login now"
                                    class="img-fluid" width="450">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 col-12 order-md-2 order-1 p-0">
                        <div class="register-page-form">
                            ...
                            <form name="signinform" class="row sign-in-form auth-form g-3"
                                action="{{ route('customer.authenticate') }}" method="post">
                                <!-- Form Input -->
                                <div class="col-md-12">
                                    <p class="p-sm input-header">Mobile Number</p>
                                    <input class="form-control numeric-input" type="text" name="mobile" placeholder="Mobile Number"
                                        id="mobile" maxlength="10" minlength="10" autocomplete="off"
                                        inputmode="numeric">
                                ...
                                <div class="col-md-12">
                                    <div class="reset-password-link text-end">
                                        <p class="p-sm mb-0"><a href="{{ route('customer.forget.password') }}"
                                                class="color--theme">Forgot your password?</a></p>
                                    </div>
                                </div>
                                <!-- Form Submit Button -->
                                <div class="col-md-12">
                                    <button type="submit" class="btn btn--theme hover--theme submit btn-login mt-0">Log
                                        In</button>
                                </div>
                                <!-- Sign Up Link -->
                                <div class="col-md-12">
                                    <p class="create-account text-center mt-0">
                                        Don't have an account? <a href="{{ route('self.apply.main') }}"
