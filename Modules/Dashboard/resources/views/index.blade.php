...
@section('content')
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        <div class="container-xxl" id="kt_content_container">
            <div class="row g-8 g-xl-10 mb-10">
                ...
                <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                    <div class="row g-8 mb-xl-10">
                        <div class="col-md-6 col-sm-12 col-lg-6 col-xl-6 col-xxl-6">
                                                                    ...
                                                                    <div class="d-flex flex-column">
                                                                        ...
                                                                        <div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
                                                                            <a href="javascript:;" class="d-flex align-items-center text-gray-700 text-hover-success me-5 mb-2">
                                                                                <i class="ki-duotone ki-phone fs-4 me-1"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i>
                                                                                {{ isset($agent->mobile) ? '+91 '.substr($agent->mobile, 0, 5) . ' ' . substr($agent->mobile, 5) : '+918488848968' }}
                                                                            </a>
                                                                            <a href="javascript:;" class="d-flex align-items-center text-gray-700 text-hover-success me-5 mb-2">
                                                                                <i class="ki-duotone ki-geolocation fs-4 me-1"><span class="path1"></span><span class="path2"></span></i>
                            ...
                            @else
                                <div class="card" data-bs-theme="light" style="background: linear-gradient(112.14deg, #0c3e65 0%, #87b9e9 100%)">
                                    <div class="card-body">
                                        <div class="row align-items-center h-100">
                                            <div class="col-12">
                            ...
                            <div class="card border mt-10" data-bs-theme="light">
                                <div class="card-body">
                                    <div class="align-items-center">
                                        <div class="pt-4" style="color:#0c3e65 !important">
