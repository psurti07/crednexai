                ...
                <tbody>
                    <tr>
                        <td class="es-m-margin" valign="top" style="padding: 0; margin: 0;">
                                                                    ...
                                                                    <tr>
                                                                        <td class="es-m-p20b" align="left"
                                                                            ...
                                                                            <table cellpadding="0" cellspacing="0"
                                                                                width="100%"
                                                                                style="mso-table-lspace: 0; mso-table-rspace: 0; border-collapse: separate; border-spacing: 0;"
                                                                                role="presentation">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td
                                                                                            style="padding: 20px; margin: 0; line-height: 1rem;">
                                                                                            <p
                                                                                                style="font-size:1.5rem;color:#035bac;font-weight:600">
                                                                                                Welcome Onboard
                                                                                            </p>
                                                                                            <span style="font-size:1rem">Your Loan Approval Journey Begins Now!</span>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                            ...
                            <table class="es-content" cellspacing="0" cellpadding="0" align="center"
                                style="mso-table-lspace: 0; mso-table-rspace: 0; border-collapse: collapse; border-spacing: 0; table-layout: fixed !important;">
                                <tbody>
                                    <tr>
                                        <!-- personal details section starts -->
                                        <td align="left" style="padding: 0; margin: 0;">
                                            <table class="es-content-body" cellspacing="0" cellpadding="0" align="center"
                                                style="mso-table-lspace: 0; mso-table-rspace: 0; border-collapse: collapse; border-spacing: 0; background-color: transparent; width: 600px; display: inline-block;">
                                                <tbody>
                                                    <tr>
                                                        <td align="left"
                                                            style="padding: 0; margin: 0; padding-top: 10px; padding-bottom: 10px;">
                                                            <table cellpadding="0" cellspacing="0" class="es-left"
                                                                align="left"
                                                                style="mso-table-lspace: 0;mso-table-rspace: 0;border-collapse: collapse;border-spacing: 0;float: left;background-color: #E9F2FB;border: 1px solid #0c3e65;  border-radius: 12px; display: block;">
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="es-m-p20b" align="left"
                                                                            style="padding: 0; margin: 0; width: 600px;">
                                                                            <h3 style="text-align:center; color: #035bac;">
                                                                                {{ $userData->first_name }}&nbsp;{{ $userData->last_name }}
                                                                            </h3>
                                                                            <hr>
                                                                            <table cellpadding="0" cellspacing="0"
                                                                                width="100%" bgcolor="#ffffff"
                                                                                style="mso-table-lspace: 0;mso-table-rspace: 0;border-collapse: separate;border-spacing: 0; border-radius: 15px;/* border: 1px solid #0c3e65; */ background-color: transparent;"
                                                                                role="presentation">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td
                                                                                            style="padding:10px  20px; margin: 0; line-height: 1.5rem;background-color: #ffffff; color:#000;font-size:16px;border-bottom-left-radius:12px;">
                                                                                        ...
                                                                                        <td align="left"
                                                                                            style="padding:10px 20px; margin: 0; line-height: 1.5rem;background-color: #ffffff; color:#000;font-size:16px;border-bottom-right-radius:12px;">
                                                    ...
                                                    <tr>
                                                        <td align="left" style="font-family: Poppins, sans-serif; margin: 0; line-height: 1.5rem; border-radius: 12px; color: #000; font-size: 16px; width: 33.33%; text-align: center;">
                                                            <p style="color: #0c3e65; font-size: 14px; margin: 0;">
                                                                Pre-Approved Amount
                                                                <br />
                                                                <strong style="color: #1f2f33; font-size: 18px; display: block; padding-top: 5px;">₹ {{ formatePriceIndia($loanData->loan_amount) }}</strong>
                                                            </p>
                                                        </td>
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="center"
                                                                                            ...
                                                                                            <span style="font-size:1.2rem">Relish Instant Process with 100% Online Process</span>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                        ...
                                        <tr>
                                            <td class="es-m-p20b" align="left" style="padding: 0; margin: 0; width: 100%;">
                                                <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff"
                                                    style="mso-table-lspace: 0;mso-table-rspace: 0;border-collapse: separate;border-spacing: 0; border-radius: 15px; background-color: transparent;"
                                                    role="presentation">
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                        ...
                                                        <td align="left" style="padding: 0; margin: 0; padding-top: 0px; padding-bottom: 0px;">
                                                            <table cellpadding="0" cellspacing="0" class="es-left" align="left" style="mso-table-lspace: 0; mso-table-rspace: 0; border-collapse: collapse; border-spacing: 0; float: left;">
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="es-m-p20b" align="left" style="padding: 0; margin: 0; width: 600px;">
                                                                            <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace: 0; mso-table-rspace: 0; border-collapse: separate; border-spacing: 0; border-radius: 15px;" role="presentation">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td
                                                                                            align="center"
                                                                                        ...
                                                                                        >
                                                                                            ...
                                                                                            >
                                                                                                <span>
                                                                                                    <strong><span style="font-family: Poppins, sans-serif; font-size: 20px; text-transfrom: uppercase;">Unlock your Loan Offers </span></strong>
                                                                                                </span>
                                                                                            </a>
                                                                                            <p
                                                                                                style="
                                                                                                ...
                                                                                                "
                                                                                            >
                                                                                                *The above data is tentative and purely on the information provided by you to CredNexAI. Final EMI, loan sanction, loan approval, and loan amount depend on customer
                                                                                                ...
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td align="center"
                                                                                                            ...
                                                                                                            style="padding: 0; margin: 0;padding-right:10px">
                                                                                                            <a target="_blank"
                                                                                                                href="https://www.facebook.com/@crednexai.com"
                                                                                                                style="
                                                                                                                -webkit-text-size-adjust: none;
                                                                                                                -ms-text-size-adjust: none;
                                                                                                                mso-line-height-rule: exactly;
