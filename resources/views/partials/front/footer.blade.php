            ...
            <div class="col-xl-4 mb-sm-20 mb-md-20">
                <div class="footer-info">
                    ...
                    <div class="fs-6 mt-3 mb-5 text-light">
                        <p>CredNexAI is India's thriving financial consultation and service provider that streamlines the loan process through its NBFC partners, giving you the option to apply on your own using the self-apply feature or hire a loan agent to make better borrowing decisions.</p>
                    </div>
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <div class="footer-copyright">
                        <p class="mt-0"><span class="text-light">{{ date('Y') }} &copy; {{ env('COMPANY_NAME') }} All Rights Reserved.</span></p>
                    </div>
                </div>
