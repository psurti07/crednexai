                                        ...
                                        <div class="row gx-3 gy-3">
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <label class="card border-0">
                                                    <input name="plan" value="1" class="radio d-none" type="radio" checked data-plan="Self-Apply">
                                                    <div class="plan-details">
                                                        <h5 class="fw-bolder s-16 plan-type mb-10">Self-Apply Plan</h5>
                                                       
                                                        <div class="corner-ribbon" data-offer="{{ calPercentage($selfApply->amount, $selfApply->offeramount) }} OFF"></div>

                                                        <div class="price my-2">
                                                            <!-- Monthly Price -->	
                                                            <div class="price2" >
                                                                <sup class="color--black">₹</sup>	
                                                                <sup class="coins color--red-300"><strike>{{intval($selfApply->amount)}}</strike></sup>							
                                                                <span class="color--black">{{intval($selfApply->offeramount)}}</span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="order-summary">
                                                            ...
                                                            <div class="order-row">
                                                                <span>Price</span>
                                                                <span>{{formatePriceIndia($selfApply->amount)}}</span>
                                                            </div>

                                                            <div class="order-row order-discount">
                                                                <span>Discount</span>
                                                                <span>- {{formatePriceIndia($selfApply->amount - $selfApply->offeramount)}}</span>
                                                            </div>

                                                            <div class="order-row">
                                                                <span>Offer Amount</span>
                                                                <span>{{formatePriceIndia($selfApply->offeramount)}}</span>
                                                            </div>

                                                            <div class="order-row">
                                                                <span>GST</span>
                                                                <span>+ {{formatePriceIndia($selfApply->offeramount * 0.18)}}</span>
                                                            </div>
                                                            ...
                                                            <div class="order-row order-total">
                                                                <span>Total</span>
                                                                <span>₹ {{formatePriceIndia($selfApply->offeramount + ($selfApply->offeramount * 0.18))}}</span>
                                                            </div>
                                                        </div>
