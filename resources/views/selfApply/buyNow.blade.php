...
@section('content')
<section id="contacts"
    class="bg--white-100 bg--fixed pb-80 personal-details-form d-flex align-items-centerr">
    <div class="container">
                                        ...
                                        <div class="plan-details">
                                            ...
                                            <div class="order-summary">
                                                ...
                                                <div class="order-row order-total">
                                                    <span>Total</span>
                                                    <span>₹
                                                        {{formatePriceIndia($selfApply->offeramount + ($selfApply->offeramount * 0.18))}}</span>
                                                </div>
                                            </div>

                                            <button type="submit" class="btn btn-sm btn--theme hover--theme" id="submit-btn">Buy Now</button>
                                        </div>
                                    </label>
                                </div>
