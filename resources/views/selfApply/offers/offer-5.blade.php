    ...
    <div class="container">
        <div class="row d-flex align-items-center">
            <div class="col-md-12 col-lg-6 order-2 order-md-2 order-lg-1">
                <div class="img-block">
                    <img src="{{ asset('front/images/offer/self-apply-great-offer.jpg') }}" alt="selfapply nbfc list"
            ...
            <div class="col-md-12 col-lg-6 self-apply-form order-1 order-md-1 order-lg-2 mb-md-0 mb-3">
                <div id="hero-8-form" class="r-06">
                    ...
                    <form method="post" class="request-form save-form-1" action="{{ route('self.apply.get.offer5') }}">
                        <div class="row g-2">
                            <div class="col-md-12">
