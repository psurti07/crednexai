        ...
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-md-12 col-lg-6 order-2 order-md-2 order-lg-1">
                        <div class="img-block">
                            <img src="{{ asset('front/images/offer/self-apply-standard-offer.jpg') }}" alt="selfapply nbfc list" class="img-fluid rounded-4">
                        </div>
                 </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 col-lg-12">
                    <div class="section-title text-center mb-40">
                        <h2 class="s-28 w-700">Our <span class="color--green-500">Happy Customer</span></h2>
