...
<section class="bg--white-100 bg--fixed pt-110 pb-80">
    <div class="container">
        <div class="row justify-content-center align-items-center m-auto">
            <div class="col-md-8 col-lg-8 self-apply-form mb-lg-0 mb-md-4 mb-4 mt-3">
                        ...
                        <div class="row g-2">
                                        ...
                                        <div class="col-md-6 col-lg-6 col-sm-6 mb-2">
                                            <fieldset class="picker1">
                                                <label class="card" for="personalloan">
                                                    <input type="radio" name="loan_type" id="personalloan" value="1" {{ ($loan_type ?? '') == 1 ? 'checked' : '' }} class="radio" checked>
                            ...
                            <div class="col-md-12">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="mobile" id="mobile" class="numeric-input form-control name" placeholder="Enter Your Mobile*" autocomplete="off" required maxlength="10" minlength="10" inputmode="numeric" value="{{ $mobile ?? '' }}">
                                </div>
            ...
            <div class="row g-3 row-cols-1 row-cols-md-2 row-cols-lg-4">
                <div class="col">
                    <div class="fbox-8 fbox--hover fb-1 r-12 h-100">
                        ...
                        <div class="fbox-txt">
                            <h4 class="s-18 w-700">Access To Multiple NBFCs</h4>
                            <p>Benefit from our enriching partnership with multiple industry-leading NBFCs to process your loan with ease.</p>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="fbox-8 fbox--hover fb-1 r-12 h-100">
                        ...
                        <div class="fbox-txt">
                            <h4 class="s-18 w-700">Easy Online Process</h4>
                            <p>Relax and enjoy the convenience of the most straightforward online portal from the comfort of your own home.</p>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="fbox-8 fbox--hover fb-1 r-12 h-100">
                        ...
                        <div class="fbox-txt">
                            <h4 class="s-18 w-700">Tailored Financial Solutions</h4>
                            <p>Our one-size-doesn’t-fit-all approach helps you get the financial solution that is tailored to your financial needs </p>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="fbox-8 fbox--hover fb-1 r-12 h-100">
                        ...
                        <div class="fbox-txt">
                            <h4 class="s-18 w-700">Expert Guidance </h4>
                            <p>Make sound financial decisions with our experienced team of experts to make your financial journey easier.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12 col-lg-12 col-xl-12">
                <div class="form-holder">
                    <div class="contact-form-notice">
                        <p class="s-14">
                            <strong>Disclosure:</strong> Loan repayment tenure ranges from a minimum of 6 months to a maximum of 60 months (5 years), depending on the lender’s policies and applicant eligibility. The maximum APR (Annual Percentage Rate), inclusive of interest rate, processing fees, and applicable charges, may go up to 34% per annum depending on the applicant’s profile and the policies of the respective lending partner. the Processing fees may be charged up to 2% of the approved loan amount. Representative Example: For a loan amount of ₹1,00,000 at an interest rate of 11.5% per annum for a tenure of 60 months (5 years), with a processing fee of 2% (₹2,000): Approximate EMI: ₹2,301, Total Interest Payable: ₹38,059, Total Cost of the Loan: ₹1,38,059, Indicative APR: Approximately 14.41% per annum. *T&C Apply. All figures provided above are illustrative and indicative in nature. Actual loan terms may vary based on the applicant’s profile & lender policies.
                        </p>
                        <p class="s-14">
                            <strong>Disclaimer:</strong> CredNexAI is a loan service aggregator and is authorised to provide services on behalf of its Lending Partners.The amount paid is only for the service charge. We are not lenders and do not guarantee any loan approval.
                        </p>
                        <p class="s-14">
