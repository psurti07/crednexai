                                                                        ...
                                                                        <td class="es-m-p20b" align="left"
                                                                            ...
                                                                            <table cellpadding="0" cellspacing="0"
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="center"
                                                                                            style="padding: 20px; margin: 0; line-height: 2rem;    background-color: #f3ead6;border-top-right-radius:12px;border-top-left-radius:12px;">
                                                                                            <p
                                                                                                style="font-size:2.2rem;color:#0c3e65;font-weight:600">
                                                                                                Congratulations! 
                                                                                            </p>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td align="left"
                                                                                            ...
                                                                                            <p>Hi {{ $fullname }}</p>
                                                                                            <p>Congratulations on taking the first step toward accessing your personalised pre-approved loan offers and expert loan consultation!</p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td align="left"
                                                            ...
                                                            <table cellpadding="0" cellspacing="0" class="es-left"
                                                                align="left"
                                                                style="mso-table-lspace: 0;mso-table-rspace: 0;border-collapse: collapse;border-spacing: 0;float: left;background-color: #f3ead6;border: 1px solid #0c3e65;  border-radius: 12px; display: block;">
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="es-m-p20b" align="left"
                                                                            style="padding: 0; margin: 0; width: 600px;">
                                                                            <h3 style="text-align:center; color: #0c3e65;">
                                                                                Order Details
                                                                            </h3>
                                                                            <hr>
                                                                            <table cellpadding="0" cellspacing="0"
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td
                                                                                            style="padding:0  20px; margin: 0; line-height: 1.5rem;background-color: #f3ead6; color:#000;font-size:16px; border-radius: 12px;">
                                                                                            <p style="margin: 0;">Full Name :<span></span>
                                                                                            <h5 style="margin:0;">{{ $fullname }}</h5>
                                                                                            </p>
                                                                                            <p style="margin: 0;">Order Id :
                                                                                            <h5 style="margin: 0;">#ORD{{ $order_number }}</h5>
                                                                                            </p>
                                                                                            <p style="margin: 0;">Transaction Id:
                                                                                            <h5 style="margin: 0;">{{ $transactionId }}</h5>
                                                                                            </p>
                                                                                        </td>
                                                                                        <td align="left"
                                                                                            style="padding:0 20px; margin: 0; line-height: 1.5rem;background-color: #f3ead6;  color:#000;font-size:16px;border-radius: 12px;">
                                                                                            ...
                                                                                            <p style="margin: 0;">Payment Amount :
                                                                                            <h5 style="margin: 0;">&#8377;{{ formatePriceIndia($order_amount) }}</h5>
                                                                                            </p>
                                                                                            <p style="margin: 0;">Transaction Date/Time:
                                                                                            <h5 style="margin: 0;">{{ date('M d, Y', strtotime($order_date)) }}</h5>
                                                                                            </p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                        ...
                                                                        <td class="es-m-p20b" align="left"
                                                                            ...
                                                                            <table cellpadding="0" cellspacing="0"
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="left"
                                                                                            style="padding: 20px; margin: 0; line-height: 1.5rem;background-color: #f3ead6; border-radius:12px;color:#000;font-size:16px">
                                                                                            <p>
                                                                                                Your Loan Consultation Details :
                                                                                            </p>
                                                                                            <p>Agent Name : <strong>{{ $agentName
                                                                                                }}</strong>
                                                                                            </p>
                                                                                            <p>Agent Mobile : <strong>{{
                                                                                                $agentMobile }}</strong>
                                                                                            </p>
                                                                                            
                                                                                            <p>Our Loan Consultant will reach out to you within 24 to 48 hours.</p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
