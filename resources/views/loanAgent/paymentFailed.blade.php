                ...
                <div class="card">
                    <div class="card-body">
                        <div class="text-center mb-20">
                            ...
                            <p>We're sorry, but your payment could not be processed. Please try again or contact our
                                support team for assistance.</p>
                            <p>हमें खेद है, लेकिन आपका भुगतान प्रोसेस नहीं हो सका। कृपया पुनः प्रयास करें या सहायता
                                के लिए हमारी सपोर्ट टीम से संपर्क करें।</p>
                        </div>
                        ...
                        <div class="text-center mb-20">
                            ...
                            <p class="mt-20 mb-0 small text-danger">Don't worry! No amount has been deducted from
                                your account.</p>
                        </div>
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-center mt-20">If you've any queries/ issues, kindly raise a request here:
                                <a href="{{ route('front.raise.request') }}" class="text-success">Click Here</a>
                            </p>
                        </div>
