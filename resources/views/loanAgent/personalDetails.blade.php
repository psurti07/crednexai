                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="row">
                            ...
                            <div class="col-md-9 col-lg-9 col-12">
                                <div class="card">
                                    <form action="{{ route('loan.agent.personal.details.store') }}" id="personalDetailForm" class="contact-form save-form-4" novalidate="novalidate" method="post" accept-charset="utf-8">
                                        <div class="card-body">
