...
@endpush
@section('content')
<section class="bg--fixed hero-section pb-80 pt-110">
    <div class="container">
        <div class="row d-flex align-items-center">
            <div class="col-md-12 col-lg-6 order-2 order-md-2 order-lg-1">
                <div class="img-block">
                    <img src="{{ asset('front/images/offer/loan-agent-big-benefit-offer.jpg') }}" alt="selfapply nbfc list"
            ...
            <div class="col-md-12 col-lg-6 self-apply-form order-1 order-md-1 order-lg-2 mb-md-0 mb-3">
                <div id="hero-8-form" class="r-06">
                    ...
                    <form method="post" class="request-form save-form-1" action="{{ route('loan.agent.get.offer5') }}">
                        <div class="row g-2">
                            <div class="col-md-12">
                    ...
                    <p class="p-sm mt-3 mb-0">By submitting the form & proceeding, you agree to the <a
                            ...
                            class="text-dark text-decoration-none"> Privacy Policy</a> of CredNexAI.</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="form-holder">
                    <div class="contact-form-notice">
                        ...
                        <p class="s-14">
                            ...
                            website https://crednexai.com and NOT through any other source, directly or indirectly.
                            Thanks!
                        </p>
                    </div>
                </div>
