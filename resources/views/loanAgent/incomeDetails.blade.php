            ...
            <div class="row d-flex align-items-center justify-content-center">
                <div class="col-md-6 col-lg-6 self-apply-form">
                    <div id="hero-8-form" class="border border-primary r-06">
                        ...
                        <form method="post" action="{{ route('loan.agent.loan.details.store') }}" class="request-form save-form-3 needs-validation" novalidate>
                            <div class="row">
                                ...
                                <div class="col-md-12 form-btn">
                                    <button type="submit" class="btn btn--theme hover--theme submit processNowBtn" id="processNowBtn" onclick="_tfa.push({notify: 'event', name: 'hire_lead', id: 1776413})">Process Now</button>
                                </div>
                            </div>
                        </form>
                    </div>
