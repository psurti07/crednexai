...
@section('content')
    <section class="bg--white-100 personal-details-form inner-page-hero contacts-section division min-vh-100 d-flex align-items-center">
        <div class="container">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6 col-12">
                                                        ...
                                                        <div id="fb-12-3" class="fbox-12 bg--white-100 block-shadow r-12 mb-20">
                                                            ...
                                                            <div class="fbox-ico">
                                                                <div class="shape-ico">
                                                                    <img class="p-0" src="https://managecrednexai.com/upload/banks/{{ $offersData[0]['bank_image'] }}" alt="bank" width="160">
                                                                </div>
                                                            </div>	<!-- End Icon -->
