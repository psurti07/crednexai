...
class SelfApplyController extends Controller
{
    ...
    public function main(Request $request)
    {
        ...
        $mobile = session()->pull('mobile');
        $loan_type = session()->pull('loan_type');
        ...
        return view('selfApply.main', compact('meta', 'mobile', 'loan_type'));
    }
            ...
            if (isset($loanType, $applyId, $orderId) && $loanType !== null && $applyId !== null && $orderId !== null) {
                ...
                if (isset($responsecode) && $responsecode == 100) {
                    ...
                    $fbdata = array(
                        ...
                        'sourceurl' => 'https://crednexai.com/self-apply/paymentSuccess'
                    );
    ...
    public function getOffer1(Request $request)
    {
        try {
            ...
            $returnUrl = 'https://crednexai.com/api/self-apply/prime-offer-response';
    ...
    public function getOffer3_cipherpay(Request $request)
    {
        try {
            ...
            $orderId = number_format(microtime(true) * 1000, 0, '.', '');
            $encData = null;
            $returnUrl = 'https://crednexai.com/api/self-apply/premium-offer-response';
    ...
    public function getOffer4_subpaisa_old(Request $request)
    {
        try {
            ...
            Log::info('SABPAISA_MODE' . config('constant.SABPAISA_MODE'));
            Log::info('SABPAISA_CLIENT_CODE' . config('constant.SABPAISA_CLIENT_CODE'));
            Log::info('SABPAISA_USERNAME' . config('constant.SABPAISA_USERNAME'));
            Log::info('SABPAISA_PASSWORD' . config('constant.SABPAISA_PASSWORD'));
    ...
    public function offer4Response_subpaisa(Request $request)
    {
        try {
            ...
            $AesCipher = new Authuntication();
            $decText = $AesCipher->decrypt($query);
